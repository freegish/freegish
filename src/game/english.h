...
#define TXT_TUTORIAL_LINE8							"Some blocks cannot be stuck to."
#define TXT_TUTORIAL_LINE9							"You have to jump. Press the '/s' key to jump."
#define TXT_TUTORIAL_LINE10							"Gish jumps best when he is the most compressed."
#define TXT_TUTORIAL_LINE11							"Holding up, down and jump keys will"
#define TXT_TUTORIAL_LINE12							"help you get higher and higher."
#define TXT_TUTORIAL_LINE13							"Press the '/s' key to become Reeeeally HEAVY and break"
#define TXT_TUTORIAL_LINE14							"these blocks. You are harder to kill when you are heavy."
#define TXT_TUTORIAL_LINE15							"Press the '/s' key to stick to"
#define TXT_TUTORIAL_LINE16							"the wall.  Press up and towards"
#define TXT_TUTORIAL_LINE17							"the wall to climb. If you are"
...
#define TXT_LOAD_LEVEL_OK               "Level loaded!"
#define TXT_LOAD_LEVEL_UNKNOWN          "Level not loaded :("
#define TXT_LOAD_LEVEL_FILEERROR        "Level file not found"
#define TXT_LOAD_LEVEL_TOO_MANY_OBJECTS "Level has too many objects"
#define TXT_LOAD_LEVEL_TOO_MANY_ROPES   "Level has too many ropes"
#define TXT_LOAD_LEVEL_TEXTURE_SIZEX_TOO_BIG "Texture in this level is too bix (sizex)"
#define TXT_LOAD_LEVEL_TOO_MANY_BLOCK_LINES  "Level has too many block lines"
